Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/westonfw/PocketSocket'
  s.authors  = { 'Robert Payne' => 'westonfw@gmail.com' }
  s.source   = { :git => 'https://github.com/westonfw/PocketSocket.git', :tag => '1.0.1.1' }
  s.requires_arc = true
